...
main.app.disappear = function(){
	var oTopAd = document.getElementById('top_ad_wrap');
	var oSpan = oTopAd.getElementsByTagName('span')[0];
	oSpan.onclick = function(){
		startMove(oTopAd, {opacity:0}, function(){
...
main.app.imageChange = function(){
	...
	var oWrap = document.getElementById('image_wrap');
	var aImg = oWrap.getElementsByTagName('a');
	var oPrev = oWrap.getElementsByClassName('prev')[0];
	var oNext = oWrap.getElementsByClassName('next')[0];
